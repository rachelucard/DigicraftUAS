...
<div class="panel-heading" style="background:#d225fc; color:white"><h3 class="panel-title" style="text-align:center;">DigiCraft Umsida</h3></div>
<div class="panel-body">
    ...
    <?php endif;?>
        ...
        <form id="loginForm" method="POST" action="daftar_user.php" novalidate="novalidate">
        <fieldset>
        <div class="form-group"><div align="center"><img src="img/logo.jpeg" height="150" width="150" ></div></div><p>
        
        
        <div class="form-group">
        <input type="varchar" class="form-control" id="nama_lengkap" name="nama_lengkap" value="" required="" 
        title="Please enter you username" placeholder="Nama Lengkap">
        </div><p>
        
        <div class="form-group">
        <input type="varchar" class="form-control" id="username" name="username" value="" required="" title="Please enter you username" placeholder="Username"></div><p>
        
        <div class="form-group">
        <div class="form-group"><input type="password" class="form-control" id="password" name="password" value="" required="" title="Please enter your password" placeholder="Password"></div><p>
        
        <div class="checkbox"><label><input name="remember" type="checkbox" value="Remember Me">Remember Me</label></div>
		<button type="submit" class="btn btn-success btn-block">Daftar</button>
        <p>
        <p>Apakah Anda Sudah Punya Akun? <strong><a href="index.php" class="blue-text">Login Segera!</a></strong></p>
        </form>
</div></div></div></div></div>
