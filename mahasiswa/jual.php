...
<div class="banner_top innerpage" id="home">
	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<h3 class="head">Iklankan Karyamu</h3>
			<p class="head_para">Lebih banyak berkarya lebih banyak uang</p>
			<div class="inner_section_w3ls">
				<div class="col-md-7 contact_grid_right">
					<h6>Isilah form di bawah ini. </h6>
					<form action="proses_jual.php" method="post" enctype="multipart/form-data">

						<div class="col-md-6 col-sm-6 contact_left_grid">
							<input type="varchar" class="form-control" name="nama_karya" placeholder="Nama Karya" required="">
							<br>
                        ...
                        <div class="col-md-6 col-sm-6 contact_left_grid">
							...
							<input type="int" class="form-control" name="harga" placeholder="Masukan Harga" required="">
							<br>
							<input type="varchar" class="form-control" value="No.Rekening : 1000200030" required="" disabled>
							<br>
						</div>

						<div class="col-md-6 col-sm-6 contact_left_grid">
							            <label><i aria-hidden="true"></i>Unggah File</label>
                                        <input type="file" class="form-control" name="fuploads" id="fuploads" class="form-control">
                                        <br>
										<input type="varchar" class="form-control" name="telefon" placeholder="Telefon" required="Masukan Nomer Telepon">  				
						</div>

						<div class="col-md-6 col-sm-6 contact_left_grid">
						<label><i aria-hidden="true"></i>Tanggal Unggah</label>                
						                <input type="date" class="form-control" name="tgl_upload">
                        <br>
						<input type="varchar" class="form-control" name="email" value="<?=$row['email'];?>" placeholder="Masukan Email">
                         </div>
