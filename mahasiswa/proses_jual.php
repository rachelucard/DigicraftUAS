...
$sql = "INSERT INTO karya (nama_karya,deskripsi,nama_lengkap,harga,tgl_upload,email,telefon,file) VALUES ('$nama_karya', '$deskripsi', '$nama_lengkap','$harga', '$tgl_upload', '$email','$telefon', '$file')";
