...
<li><a href="../guest/guest.php"><i class="fa fa-users fa-fw"></i> <span class="menu-text">Guest</span><span class="selected"></span></a></li>
        ...
        <div id="page-wrapper">
          ...
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Lihat Mahasiswa</h2>
            <p>Lihat Akun Mahasiswa</p>
						 <form action="" class="templatemo-login-form" method="post" enctype="multipart/form-data">
					<a href="../../mahasiswa/images/<?php echo $row['foto']; ?>"><img style="margin-top: 30px; margin-left: 560px; position: absolute;"class="img-responsive center-block" src="../../mahasiswa/images/<?php echo $row['foto']; ?>" width="200" height="190"></a><br />
			...
			<a href="edit_mahasiswa.php?username=<?php echo $row['username']; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit Akun</a>
