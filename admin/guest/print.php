...
<div style="text-align:right;"><a class="no-print" href="javascript:printDiv('print-area-1');">Print</a>&nbsp;&nbsp;<a class="no-print" href="guest.php">Kembali</a></div>
...
<div align="center">
  <table width="819" height="auto" border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
      ...
      <td width="142"><div align="center"><strong>EMAIL</strong></div></td>
      <td width="200"><div align="center"><strong>NOMER REKENING</strong></div></td>
    </tr>
	<?php $sql = mysqli_query($koneksi, "SELECT * FROM guest ORDER BY username ASC");
