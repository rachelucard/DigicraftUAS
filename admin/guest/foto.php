...
<li><a href="upload/download.php"><i class="fa fa-tasks fa-fw"></i> <span class="menu-text">Penyimpanan File</span><span class="selected"></span></a></li></ul>
</div></div></nav>

<div id="page-wrapper"><br><div class="row"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-body">
<a href="guest.php" style="float:right"><button type="button" class="btn btn-default">Kembali</button></a>
<div class="templatemo-content-container"><div class="templatemo-content-widget white-bg"><h2 class="margin-bottom-10">Sistem Informasi &raquo; Upload Foto</h2><p>Upload Foto untuk Guest User <b><?php echo $_GET['username']; ?></b></p>
			...
			if(isset($_FILES['filetoupload'])){
				...
				if ($uploadOk == 0) {
					...
					if (move_uploaded_file($_FILES["filetoupload"]["tmp_name"], $file)) {
						$up = mysqli_query($koneksi, "UPDATE guest SET foto='$new_username' WHERE username='$username'");
						if($up){
