...
if(isset($_POST['btnUpload'])){
	...
	if($eror == true){
		...
		if(move_uploaded_file($_FILES['data_upload']['tmp_name'], $folder.$file_name)){
			...
			$catat = mysql_query('insert into file_upload(Filename,nik_upload,nama,Detail,Folder,DateUpload) values ("'.$file_name.'", "'.$_POST['nik_upload'].'", "'.$_POST['nama'].'", "'.$_POST['keterangan'].'", 
