...
$show = "SELECT * FROM user WHERE  username='$username'";
// eksekusi query
...
<div class="banner_top innerpage" id="home">
				...
				<div class="col-md-7 contact_grid_right">
					...
					<form action="proses_jual.php" method="post" enctype="multipart/form-data">
						<div class="col-md-6 col-sm-6 contact_left_grid">
							...
							<input type="int" class="form-control" name="harga" placeholder="Harga" required="">
							
						</div>

                        <div class="col-md-6 col-sm-6 contact_left_grid">
							<input type="varchar" class="form-control" name="username" value="<?=$_SESSION['username'];?>" required="">
							<input type="varchar" class="form-control" name="prodi" value="<?=$row['prodi'];?>" required="">
						</div>
						...
						<div class="col-md-6 col-sm-6 contact_left_grid">
                        <input type="varchar" class="form-control" name="telefon" placeholder="Telefon" required="">
						</div>
						<div class="col-md-6 col-sm-6 contact_left_grid">
	...
	<div class="newsletter_w3layouts_agile">
		...
		<div class="col-sm-6 newsright">
			<form action="#" method="post">
				<input type="email" placeholder="Enter your email..." name="surat" required="">
